...
namespace Common.Shared
{
    public class RequestAndResponseActivityMiddleware
    {
        ...
        {
            await AddRequestBodyContextToActivityTag(context);
            await AddResponseBodyContextToActivityTag(context);

        }



        private async Task AddRequestBodyContextToActivityTag(HttpContext context)
        {
        ...
        private async Task AddResponseBodyContextToActivityTag(HttpContext context)
        {
